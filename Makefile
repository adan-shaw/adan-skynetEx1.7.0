...
3rd/jemalloc/Makefile : | 3rd/jemalloc/autogen.sh
	cd 3rd/jemalloc && ./autogen.sh --with-jemalloc-prefix=je_ --enable-autogen --enable-shared --enable-static --enable-experimental-smallocx --enable-prof --enable-prof-libunwind --enable-utrace --enable-xmalloc --enable-readlinkat --enable-opt-safety-checks --enable-lazy-lock --disable-documentation --disable-debug --disable-log
